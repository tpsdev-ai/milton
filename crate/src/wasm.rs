...
pub fn q4k_run_perk(n_tokens: u32) {
    crate::qmatmul_simd128::q4k_run_variant(false, n_tokens);
}

/// One synthetic superblock × `n_tokens` of the all-k variant (calibrator).
#[wasm_bindgen(js_name = q4kRunAllk)]
pub fn q4k_run_allk(n_tokens: u32) {
    crate::qmatmul_simd128::q4k_run_variant(true, n_tokens);
}

/// Bit-exact check: `max_abs` between the two variants on the synth tile.
#[wasm_bindgen(js_name = q4kVariantMaxAbs)]
pub fn q4k_variant_max_abs() -> f32 {
    crate::qmatmul_simd128::q4k_variant_max_abs()
}
