 ...
 * @param {string} name
 */
export function q4kSetForce(name) {
    const ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.q4kSetForce(ptr0, len0);
}

/**
 * @param {number} t
 */
export function q4kSetThreshold(t) {
    wasm.q4kSetThreshold(t);
}

/**
 * @returns {number}
 */
export function q4kThreshold() {
    const ret = wasm.q4kThreshold();
    return ret >>> 0;
}
 ...
 * @param {number} n_tokens
 */
export function q4kRunBprime(n_tokens) {
    wasm.q4kRunBprime(n_tokens);
}
 ...
 * @param {number} n
 */
export function miltonSetWorkers(n) {
    wasm.miltonSetWorkers(n);
}

/**
 * @returns {number}
 */
export function miltonWorkerCount() {
    const ret = wasm.miltonWorkerCount();
    return ret >>> 0;
}
 ...
 * @param {number} id
 */
export function miltonWorkerEnter(id) {
    wasm.miltonWorkerEnter(id);
}

const MiltonFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_milton_free(ptr >>> 0, 1));
/**
...
export class Milton {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        MiltonFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_milton_free(ptr, 0);
    }
    /**
    ...
    constructor(gguf) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.milton_new(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        MiltonFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    embed(text, prefix) {
        ...
        const ret = wasm.milton_embed(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        if (ret[3]) {
     ...
     * @returns {Float32Array}
     */
    embedWithFault(text, prefix, fault) {
        const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(prefix, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(fault, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.milton_embedWithFault(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
     ...
     */
    embeddingLength() {
        const ret = wasm.milton_embeddingLength(this.__wbg_ptr);
        return ret >>> 0;
    }
}
